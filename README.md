# babel-preset-esmc [![npm version][npmv-img]][npmv-url] [![github release][ghrelease-img]][ghrelease-url] [![License][license-img]][license-url]
...
> Sharebale and the default Babel preset for the `esmc` compiler
...
## Users
You can see who uses `babel-preset-esmc` in the [USERS.md](./USERS.md) file. Please feel free adding this file if it not exists.  
...
<!-- Heading badges -->
[npmv-url]: https://www.npmjs.com/package/babel-preset-esmc
[npmv-img]: https://badgen.net/npm/v/babel-preset-esmc?icon=npm

[ghrelease-url]: https://github.com/olstenlarck/babel-preset-esmc/releases/latest
[ghrelease-img]: https://badgen.net/github/release/olstenlarck/babel-preset-esmc?icon=github

[license-url]: https://github.com/olstenlarck/babel-preset-esmc/blob/master/LICENSE
[license-img]: https://badgen.net/npm/license/babel-preset-esmc
...
[linuxbuild-url]: https://circleci.com/gh/olstenlarck/babel-preset-esmc/tree/master
[linuxbuild-img]: https://badgen.net/circleci/github/olstenlarck/babel-preset-esmc/master?label=build&icon=circleci

[codecoverage-url]: https://codecov.io/gh/olstenlarck/babel-preset-esmc
[codecoverage-img]: https://badgen.net/codecov/c/gh/olstenlarck/babel-preset-esmc

[dependencies-url]: https://david-dm.org/olstenlarck/babel-preset-esmc
[dependencies-img]: https://badgen.net/david/dep/olstenlarck/babel-preset-esmc
...
[downloads-weekly-img]: https://badgen.net/npm/dw/babel-preset-esmc
[downloads-monthly-img]: https://badgen.net/npm/dm/babel-preset-esmc
[downloads-total-img]: https://badgen.net/npm/dt/babel-preset-esmc
...
[shareu]: https://twitter.com/intent/tweet?text=https://github.com/olstenlarck/babel-preset-esmc&via=tunnckoCore
[shareb]: https://badgen.net/badge/twitter/share/1da1f2
[open-issue-url]: https://github.com/olstenlarck/babel-preset-esmc/issues/new
